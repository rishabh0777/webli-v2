  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div
          ref={cardRef}
          className="relative rounded-3xl bg-gradient-to-r from-yellow-300 via-white to-yellow-100 p-1 shadow-yellow-500/30 shadow-lg hover:shadow-yellow-500/50 hover:scale-105 transition-transform duration-300"
        >
          <div
          ...
          <div
            ...
            aria-hidden="true"
          />
          <div className="rounded-3xl bg-black px-5 sm:px-8 py-7 sm:py-9 flex flex-col md:flex-row items-start md:items-center justify-between gap-5">
